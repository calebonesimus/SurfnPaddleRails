class Post
    ...
    unless defined?(@@posts)
      @@posts = [
          ...
          Post.new(
            :id           => 4,
            :title        => "Heisenberg",
            :body         => "Saul, Saul... this man that we spoke of before, this... this person that you said could... could disappear me, get me a whole new life and make sure that I'm never found. Yeah I need him, Saul. Gus is gonna murder my whole family. I need this man now. Saul... now, Saul!
  ...
  def self.most_recent_posts
    self.all.sort_by { |object| object.created_at < Date.today }
  end
